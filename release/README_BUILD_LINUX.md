...
```bash
./release/scripts/build_linux_app.sh --version 1.3.2 --clean --with-databases
```

Output (no DB):
- `release/PrimeRL_1.3.2_app_linux_x86_64_nodb/dist/PrimeRL`

## 3) Build Debian Package

```bash
./release/scripts/build_deb.sh --version 1.3.2 --clean \
  --app-dir release/PrimeRL_1.3.2_app_linux_x86_64_nodb/dist/PrimeRL
```

Output:
- `release/PrimeRL_1.3.2_deb_amd64/dist/primerl_1.3.2_amd64.deb`

## 4) Smoke Test
Install:

```bash
sudo dpkg -i release/PrimeRL_1.3.2_deb_amd64/dist/primerl_1.3.2_amd64.deb
```
