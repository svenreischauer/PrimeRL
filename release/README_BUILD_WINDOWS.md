...
- EXE payload: `release/PrimeRL_1.1_exe_win64_nodb/dist/PrimeRL/PrimeRL.exe`
- MSI package: `release/PrimeRL_1.1_msi_win64/PrimeRL_1.1_win64.msi`
...
2. Build:
   - `powershell -ExecutionPolicy Bypass -File release/scripts/build_exe.ps1 -Version 1.1 -Clean`

The build uses assets from the existing no-database portable bundle at:
`release/PrimeRL_1.1_portable_win64_nodb/PrimeRL 1.1`.
...
1. Build MSI from existing EXE payload:
   - `powershell -ExecutionPolicy Bypass -File release/scripts/build_msi.ps1 -Version 1.1 -Clean`
2. Or build EXE first, then MSI in one call:
   - `powershell -ExecutionPolicy Bypass -File release/scripts/build_msi.ps1 -Version 1.1 -BuildExe -Clean`
