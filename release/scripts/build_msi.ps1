...
if ($BuildExe) {
    & (Join-Path $PSScriptRoot "build_exe.ps1") -Version "1.1" -Clean:$Clean
}

$exeRoot = Join-Path $repoRoot "release\PrimeRL_1.1_exe_win64_nodb\dist\PrimeRL"
...
$outputRoot = Join-Path $repoRoot "release\PrimeRL_1.1_msi_win64"
...
$msiPath = Join-Path $outputRoot "PrimeRL_1.1_win64.msi"
