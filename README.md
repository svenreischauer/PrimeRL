...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\release\scripts\build_exe.ps1 -Version 1.3.1 -Clean
powershell -NoProfile -ExecutionPolicy Bypass -File .\release\scripts\build_msi.ps1 -Version 1.3.1 -Clean
```
...
./release/scripts/notarize_app_macos.sh --app release/PrimeRL_1.3.1_app_macos_arm64_nodb/dist/PrimeRL.app --keychain-profile PRIMERL_NOTARY
```
...
./release/scripts/build_linux_app.sh --version 1.3.1 --clean
./release/scripts/build_deb.sh --version 1.3.1 --clean --app-dir release/PrimeRL_1.3.1_app_linux_x86_64_nodb/dist/PrimeRL
```
