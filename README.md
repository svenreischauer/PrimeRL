...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\release\scripts\build_exe.ps1 -Version 1.3.2 -Clean
powershell -NoProfile -ExecutionPolicy Bypass -File .\release\scripts\build_msi.ps1 -Version 1.3.2 -Clean
```

Build macOS `.app` and signing artifacts:

```bash
./release/scripts/build_app_macos.sh --version 1.3.2 --clean
./release/scripts/sign_app_macos.sh --app release/PrimeRL_1.3.2_app_macos_arm64_nodb/dist/PrimeRL.app
./release/scripts/notarize_app_macos.sh --app release/PrimeRL_1.3.2_app_macos_arm64_nodb/dist/PrimeRL.app --keychain-profile PRIMERL_NOTARY
```
...
./release/scripts/build_linux_app.sh --version 1.3.2 --clean
./release/scripts/build_deb.sh --version 1.3.2 --clean --app-dir release/PrimeRL_1.3.2_app_linux_x86_64_nodb/dist/PrimeRL
```
